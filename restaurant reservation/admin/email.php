...
?>
    ...
    <p> 
   		<span><strong><?php _e('Field Content',PLUGIN_NAME) ?></strong><span>
    	<span>
	...
	/*=====================================
		1.	GENERAL FIELD
	=====================================*/?>
    <h2 class=""><?php _e('GENERAL',PLUGIN_NAME) ?></h2>
	...
	/*=====================================
		2.	CONFIRMATION FIELD
	=====================================*/?>
	<h2 class=""><?php _e('Confirmation',PLUGIN_NAME) ?></h2>
    ...
    <label for="confirmation_key"><?php _e('Display Confirmation Key',PLUGIN_NAME) ?><br /><?php _e('( on List of bookings )',PLUGIN_NAME) ?></label>
	...
	/*=====================================
		3.	OWNER FIELD
	=====================================*/?>
    <h2 class=""><?php _e('Restaurant Owner',PLUGIN_NAME) ?></h2>
	...
	/*=====================================
		4.	CUSTOMER FIELD
	=====================================*/?>
    <h2 class=""><?php _e('Restaurant Customer',PLUGIN_NAME) ?></h2>
